...
export class ReservationsService {
  ...
  async createReservation(reservationData: {
    ...
    if (!customer) {
      throw new HttpException(`Cliente con ID ${customerId} no encontrado`, HttpStatus.NOT_FOUND);
    }
    ...
    if (conflict) {
      throw new HttpException('El cliente ya tiene una reserva en ese rango de fechas', HttpStatus.CONFLICT);
    }
